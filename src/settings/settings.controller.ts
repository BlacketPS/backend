...
export class SettingsController {
    ...
    changeSetting(@GetCurrentUserId() userId: string, @Body() dto: ChangeSettingDto) {
    ...
    @Patch("username")
    @HttpCode(HttpStatus.NO_CONTENT)
    changeUsername(@GetCurrentUserId() userId: string, @Body() dto: ChangeUsernameDto) {
        return this.settingsService.changeUsername(userId, dto);
    }

    @UseInterceptors(ClassSerializerInterceptor)
    @Patch("password")
    changePassword(@GetCurrentUserId() userId: string, @Body() dto: ChangePasswordDto) {
    ...
    @Patch("otp/enable")
    @HttpCode(HttpStatus.NO_CONTENT)
    enableOtp(@GetCurrentUserId() userId: string, @Body() dto: EnableOtpDto) {
    ...
    @Patch("otp/disable")
    @HttpCode(HttpStatus.NO_CONTENT)
    disableOtp(@GetCurrentUserId() userId: string, @Body() dto: DisableOtpDto) {
